...
APPLICATION='/ticketsampleapplication783'
...
DESKTOPIMAGENAME='geppettotest/ticketsampleapplication783-desktop:1.0'
...
helm install --name ticketsampleapplication783-8341 ./helm
if [ $? -eq 0 ]; then
